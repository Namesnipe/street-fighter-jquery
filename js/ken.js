...
var hadoken = function(){
    ...
    setTimeout(function() {
        ...
        var isFireballCollision = function(){ 
            console.log("fireball", $fireball.position());
            console.log("Guile", $guile.position());
            console.log("fireball", $fireball.position());
            console.log("Guile", $guile.position());
        
        var fireball_left = $fireball.position().left;
        var guile_left = $guile.position().left;
        var fireball_position = $fireball.position().left;
        var ken_left = $ken.position().left;
        var fireball_margin = parseFloat($fireball.css('margin-left'));
        console.log(fireball_margin)
                console.log(guile_left - fireball_left)
        if (
            (guile_left - fireball_left <= 40) && (guile_left - fireball_left >= -40)
            )
        {
